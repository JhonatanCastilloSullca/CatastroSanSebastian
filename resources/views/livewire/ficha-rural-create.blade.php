                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="cuc" wire:model="cuc" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="12">
                                @error('cuc')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="codigo_hoja_catastral" wire:model="codigo_hoja_catastral" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="15">
                    ...
                    <div class="row form-group">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder=""name="codigo_contr_rentas" wire:model="codigo_contr_rentas" maxlength="15">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder=""name="codigo_predial" wire:model="codigo_predial" maxlength="15">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label class="form-label d-inline-flex" > <div class="divcuadro">5</div>UNIDAD ORGANICA CATASTRAL RURAL</label>
                                <input type="text" class="form-control" placeholder=""name="unidad_organica" wire:model="unidad_organica" maxlength="15">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label class="form-label d-inline-flex" > <div class="divcuadro">5</div> UNIDAD CATASTRAL</label>
                                <input type="text" class="form-control" placeholder=""name="unidad_catastral" wire:model="unidad_catastral" maxlength="15">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="proy_cat" maxlength="20" wire:model="proy_cat">
                                @error('proy_cat')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row form-group" >
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="uni_terr" maxlength="20" wire:model="uni_terr">
                                @error('uni_terr')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="nomb_valle" maxlength="20" wire:model="nomb_valle">
                                @error('nomb_valle')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="nomb_sector" maxlength="20" wire:model="nomb_sector">
                                @error('nomb_sector')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="nomb_predio" maxlength="20" wire:model="nomb_predio">
                                @error('nomb_predio')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row form-group" >
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="num_foto" maxlength="20" wire:model="num_foto">
                                @error('num_foto')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="num_ortofoto" maxlength="20" wire:model="num_ortofoto">
                                @error('num_ortofoto')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="img_satelital" maxlength="20" wire:model="img_satelital">
                                @error('img_satelital')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="uca_ant" maxlength="20" wire:model="uca_ant">
                                @error('uca_ant')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row form-group" >
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="cord_este" maxlength="20" wire:model="cord_este">
                                @error('cord_este')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="cord_norte" maxlength="20" wire:model="cord_norte">
                                @error('cord_norte')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="datum" maxlength="20" wire:model="datum">
                                @error('datum')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="zona" maxlength="20" wire:model="zona">
                                @error('zona')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-4">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" placeholder="" name="anexodomicilio" maxlength="10" wire:model="anexodomicilio">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-4">
                            <div class="lineatoggle">
                                <div>
                                    <label class="form-label d-inline-flex" >  DECLARACION JURADA DE TODOS LOS COLINDANTES O SEIS VECINOS</label>                            
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="lineatoggle">
                                <div>
                                    <label class="form-label d-inline-flex" >  DD.JJ. DE COMITES, FONDOS U ORGANIZACION DE PRODUCTORES</label>                            
                                </div>
                                <div style="padding-left: 10px;">
                                    <div class="form-check form-switch mb-2">
                        ...
                        <div class="col-md-4">
                            <div class="lineatoggle">
                                <div>
                                    <label class="form-label d-inline-flex" >DD.JJ. DE COMITES, COMISIONES O JUNTA DE USUARIOS DE AGUA</label>                            
                                </div>
                                <div style="padding-left: 10px;">
                                    <div class="form-check form-switch mb-2">
                    ...
                    <div class="row form-group">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">56</div> PRUEBAS COMPLEMENTARIAS</label>
                            ...
                            <div class="col-md-4">
                                <div class="lineatoggle">
                                    <div>
                                        <label class="form-label d-inline-flex" >DOCUMENTO QUE ACREDITE PRESTAMO O ADELANTO DE PRESTAMOS POR CREDITO AGRARIO</label>
                                    </div>
                                    <div style="padding-left: 10px;">
                                        <div class="form-check form-switch mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="lineatoggle">
                                    <div>
                                        <label class="form-label d-inline-flex" >DECLARACION JURADA DE PAGO DEL IMPUESTO PREDIAL</label>
                                    </div>
                                    <div style="padding-left: 10px;">
                                        <div class="form-check form-switch mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="lineatoggle">
                                    <div>
                                        <label class="form-label d-inline-flex" >DOCUMENTO PUBLICO O DOCUMENTO PRIVADO, DE TRANSFERENCIA DE POSESION</label>
                                    </div>
                                    <div style="padding-left: 10px;">
                                        <div class="form-check form-switch mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="lineatoggle">
                                    <div>
                                        <label class="form-label d-inline-flex" >INSPECCIÓN JUDICIAL DE TIERRAS EN PROCESO DE PRUEBA ANTICIPADA</label>
                                    </div>
                                    <div style="padding-left: 10px;">
                                        <div class="form-check form-switch mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="lineatoggle">
                                    <div>
                                        <label class="form-label d-inline-flex" >CERTIFICADO EXPEDIDO A NOMBRE DEL POSEEDOR POR EL INEI</label>
                                    </div>
                                    <div style="padding-left: 10px;">
                                        <div class="form-check form-switch mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="lineatoggle">
                                    <div>
                                        <label class="form-label d-inline-flex" >CERTIFICADO DEL PADRON CATASTRAL DE LA DGRAAR, QUE CONSTE LA INSCRIPCIÓN DEL POSEEDOR SOLICITANTE.</label>
                                    </div>
                                    <div style="padding-left: 10px;">
                                        <div class="form-check form-switch mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="lineatoggle">
                                    <div>
                                        <label class="form-label d-inline-flex" >RECIBOS A NOMBRE DEL POSEEDOR POR CONCEPTO DE USO DE AGUA DE RIEGO, INSUMOS, MAQUINAS U OTROS.</label>
                                    </div>
                                    <div style="padding-left: 10px;">
                                        <div class="form-check form-switch mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="lineatoggle">
                                    <div>
                                        <label class="form-label d-inline-flex" >CONTRATO DE COMPRA VENTA DE LA PRODUCCION AGRARIA, PRECUARIA O FORESTAL</label>
                                    </div>
                                    <div style="padding-left: 10px;">
                                        <div class="form-check form-switch mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="lineatoggle">
                                    <div>
                                        <label class="form-label d-inline-flex" >CERTIFICADO DE INSCRIPCION DE MARCAS Y SEÑALES DE GANADO EXPEDIDO A NOMBRE DEL POSEEDOR</label>
                                    </div>
                                    <div style="padding-left: 10px;">
                                        <div class="form-check form-switch mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="lineatoggle">
                                    <div>
                                        <label class="form-label d-inline-flex" >CONSTANCIA DE REGISTRO DEL POSEEDOR INSCRITO EN EL REGISTRO DE ANA</label>
                                    </div>
                                    <div style="padding-left: 10px;">
                                        <div class="form-check form-switch mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="lineatoggle">
                                    <div>
                                        <label class="form-label d-inline-flex" >CERTIFICADO A NOMBRE DEL POSEEDOR DE DEUDAS CON FONDEAGRO, MINEAGRI U OTRA ENTIDAD FINANCIERA</label>
                                    </div>
                                    <div style="padding-left: 10px;">
                                        <div class="form-check form-switch mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="lineatoggle">
                                    <div>
                                        <label class="form-label d-inline-flex" >CERTIFICADO EN QUE CONSTE QUE EL POSEEDOR FUE PRESTATARIO DEL BANCO AGRARIO.</label>
                                    </div>
                                    <div style="padding-left: 10px;">
                                        <div class="form-check form-switch mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="lineatoggle">
                                    <div>
                                        <label class="form-label d-inline-flex" >CONSTANCIA DE POSESION OTORGADA POR LA AGENCIA AGRARIA O MUNICIPALIDAD DISTRITAL RESPECTIVA</label>
                                    </div>
                                    <div style="padding-left: 10px;">
                                        <div class="form-check form-switch mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="lineatoggle">
                                    <div>
                                        <label class="form-label d-inline-flex" >CUALQUIER OTRO DOCUMENTO DE FECHA CIERTA QUE ACREDITA LA POSESION</label>
                                    </div>
                                    <div style="padding-left: 10px;">
                                        <div class="form-check form-switch mb-2">
