    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="row form-group" id="titular{{$i}}">
                <h4 class="mb-4">DATOS DEL COTITULAR CATASTRAL</h4>
                <div class="col-md-2">
                    <div class="mb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-3">
                        <div class="mb-2">
                            <label class="form-label d-inline-flex" > <div class="divcuadrorequired">125</div> % DE COTITULAR</label>
            ...
            <div class="row form-group" id="domiclio{{$i}}">
                ...
                <div class="col-md-2">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="" name="ninteriorconductor[]" wire:model="ninteriorconductor.{{$i}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="7">
                ...
                <div class="col-md-1">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="" name="loteconductor[]" wire:model="loteconductor.{{$i}}" maxlength="7">
