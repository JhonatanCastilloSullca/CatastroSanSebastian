    ...
    <div class="row">
        <div class="col-md-2 grid-margin" >
            <nav class="navmenuvert">
                <ul>
                    ...
                    @endif
                    @if($llenadoStep >=5)
                        <li><a class="active" href="#"  wire:click="verStep(5)">Caracteristicas Titularidad</a></li>
                    @else
                    ...
                    @endif
                    @if($llenadoStep>=12)
                        <li><a class="active" href="#"  wire:click="verStep(12)">Información Complementaria</a></li>
                    @else
        ...
        @if($actualStep==1)
            <div class="row form-group">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                <input type="text" class="form-control" placeholder="" wire:model="nume_ficha_lote"> 
            ...
            <div class="row  form-group">
                <div class="col-md-12">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">3</div> CÓDIGO ÚNICO CATASTRAL - CUC</label>                        
                        <div class="row row3 mb-3" style="place-content: center;text-align: center;">
                            <div class="col-md-2">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="" readonly value="080801">
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="mb-3">
            ...
            <div class="row form-group">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">4</div> CÓD CONTRIBUYENTE DE RENTAS</label>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">5</div> CÓDIGO PREDIAL DE RENTAS</label>
            ...
            <div class="row form-group">
                <div class="col-md-12">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" style="color: red;"> <div class="divcuadro">6</div> UNIDAD ACUMULADA A CODIGO PREDIAL DE RENTAS</label>
            ...
            <div class="row form-group">
                ...
                <div class="col-md-2">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">8</div> TIPO DE PUERTA</label>
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div><!-- Col -->
                <div class="col-md-2">
                ...
                <div class="col-md-1">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">10</div> COND.NUMER.</label>
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div><!-- Col -->
            </div><!-- Row --> 
            <div class="row form-group">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">12</div> TIPO DE INTERIOR</label>
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div><!-- Col -->
                <div class="col-md-4">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">27</div> TIPO DE TITULAR</label>
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div><!-- Col -->
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">28</div> ESTADO CIVIL</label>
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div><!-- Col -->
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">29</div> TIPO DOC. IDENTIDAD</label>
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div><!-- Col -->
                <div class="col-md-3">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-2">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">13</div> COND.NUMER.</label>
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div><!-- Col -->
            </div><!-- Row --> 
            ...
            <div class="row form-group">
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">43</div> USO DEL PREDIO CATASTRAL (Descripcion)</label>
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div><!-- Col -->  
                <div class="col-md-3">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">48</div> COLINDANCIAS EN CAMPO</label>
                        <input type="text" class="form-control" placeholder="frente">
                        <input type="text" class="form-control" placeholder="derecha">
                        <input type="text" class="form-control" placeholder="izquierda">
                        <input type="text" class="form-control" placeholder="fondo">
            ...
            <h4 class="mb-4"> SERVICIOS QUE CUENTA EL PREDIO</h4>
                ...
                <div class="col-md-1">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">55</div> CONEXION TV POR CABLE O CABLE SATELITAL</label>
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div><!-- Col -->                                                            
            </div><!-- Row --> 
            ...
            <h4 class="mb-4"> CONSTRUCCIONES</h4>
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">56</div> N° PISO SOTANO MEZZANINE</label>
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div><!-- Col -->            
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">57</div> FECHA DE CONSTRUCCION</label>
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div><!-- Col -->  
                <div class="col-md-2">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">58</div> MEP</label>
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div><!-- Col -->            
                <div class="col-md-2">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">59</div> ECS</label>
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div><!-- Col -->  
                <div class="col-md-2">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">60</div>  ECC</label>
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div><!-- Col -->                                                              
            </div><!-- Row --> 
            ...
            <h4 class="mb-5"> CATEGORIAS DE CONSTRUCCION</h4>
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">61</div>ESTRUCTURA</label>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">62</div> ACABADOS</label>
            ...
            <h4 class="mb-5"> CATEGORIAS DE CONSTRUCCION</h4>
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">61</div>MUROS Y COLUMNOS</label>
                        <input type="text" class="form-control" placeholder="MUROS Y COLUMNAS">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">62</div>TECHOS</label>
                        <input type="text" class="form-control" placeholder="TECHOS">
                    </div>
                </div><!-- Col -->            
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">63</div> PISOS</label>
                        <input type="text" class="form-control" placeholder="PISOS">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">64</div> PUERTAS Y VENTANAS</label>
                        <input type="text" class="form-control" placeholder="PUERTAS Y VENTANAS">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">65</div> REVEST.</label>
                        <input type="text" class="form-control" placeholder="REVEST">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">66</div> BAÑOS</label>
                        <input type="text" class="form-control" placeholder="BAÑOS">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">67</div> INSTALACIONES ELECTRICAS</label>
                        <input type="text" class="form-control" placeholder="BAÑOS">
                    </div>
                </div><!-- Col -->                                                                           
            </div><!-- Row --> 
            ...
            <div class="row form-group">
                <div class="col-md-5">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">68</div>AREA VERIFICADA</label>
                        <input type="text" class="form-control">
                    </div>
                </div><!-- Col -->            
                <div class="col-md-5">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">69</div>UCA</label>
                        <input type="text" class="form-control" >
                    </div>
                </div><!-- Col -->                                                                           
            </div><!-- Row --> 
            ...
            <h4 class="mb-5"> % DE BIEN COMUN</h4>
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">68</div>TERRENO LEGAL</label>
                        <input type="text" class="form-control" >
                    </div>
                </div><!-- Col -->            
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">68</div>CONSTRUCCION LEGAL</label>
                        <input type="text" class="form-control" >
                    </div>
                </div><!-- Col --> 
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">68</div>TERRENO FISICO</label>
                        <input type="text" class="form-control" >
                    </div>
                </div><!-- Col -->            
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">68</div>CONSTRUCCION FISICO</label>
                        <input type="text" class="form-control">
                    </div>
                </div><!-- Col -->                                                                             
            </div><!-- Row --> 
            ...
            <h4 class="mb-5"> OBRAS COMPLEMENTARIAS</h4>
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">71</div>CODIGO</label>
                        <input type="text" class="form-control" >
                    </div>
                </div><!-- Col -->            
                <div class="col-md-5">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">72</div>DESCRIPCION</label>
                        <input type="text" class="form-control">
                    </div>
                </div><!-- Col --> 
                <div class="col-md-4">
            ...
            <div class="row form-group">
                <div class="col-md43">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">73</div>PRODUCTO TOTAL</label>
                        <input type="text" class="form-control" >
                    </div>
                </div><!-- Col -->            
                <div class="col-md-4">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">74</div>UNIDAD DE MEDIDA</label>
                        <input type="text" class="form-control" >
                    </div>
                </div><!-- Col --> 
                <div class="col-md-4">
            ...
            <h4 class="mb-5"> DOCUMENTOS</h4>
                <div class="col-md-2">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">75</div>TIPO DE DOCUMENTO</label>
                        <input type="text" class="form-control" >
                    </div>
                </div><!-- Col -->            
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">76</div>DESCRIPCION</label>
                        <input type="text" class="form-control" >
                    </div>
                </div><!-- Col --> 
                <div class="col-md-4">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">77</div>FECHA DE CONSTRUCCION</label>
                        <input type="text" class="form-control" >
                    </div>
                </div><!-- Col -->
                <div class="col-md-2">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">78</div>AREA AUTORIZADA</label>
                        <input type="text" class="form-control" >
                    </div>
                </div><!-- Col -->
            </div><!-- Row --> 
            ...
            <div class="row form-group">            
                <div class="col-md-2">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">79</div>TIPO DE DOCUMENTO</label>
                        <input type="text" class="form-control">
                    </div>
                </div><!-- Col -->            
                <div class="col-md-3">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">86</div>FECHA DE INSCRIPCION DE FABRICA</label>
                        <input type="text" class="form-control" >
                    </div>
                </div><!-- Col -->
            </div><!-- Row --> 
            ...
            <label class="form-label d-inline-flex" > <div class="divcuadro">87</div>TIPO DE PARTIDA REGISTRAL</label>
            ...
            <div class="row form-group">
            <label class="form-label d-inline-flex" > <div class="divcuadro">89</div>IDENTIFICACION DE LOS LITIGANTES</label>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        <input type="text" class="form-control" placeholder="APELLIDOS Y NOMBRES DE LITIGANTES">
                    </div>
                </div><!-- Col -->
                <div class="col-md-3">
                    <div class="mb-3">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">89</div>MANTENIMIENTO</label>
                        <input type="text" class="form-control" placeholder="TD">
                    </div>
                </div><!-- Col -->     
            </div><!-- Row --> 
            ...
            <h4 class="mb-5"> INFORMACION COMPLEMENTARIA</h4>
                <div class="col-md-3">
                    <div class="mb-3">
                        <label class="form-label d-inline-flex" > <div class="divcuadro">80</div>CONDICION DE DECLARANTE</label>
                        <input type="text" class="form-control">
                    </div>
                </div><!-- Col -->            
                <div class="col-md-3">
            ...
            <div class="action-buttons d-flex justify-content-between bg-white pt-2 pb-2">
                ...
                @if($actualStep > 1 && $actualStep <= 12)
                    <button type="button" class="btn btm-md btn-secondary" wire:click="retrocederStep()">Atras</button>
                @endif
                @if($actualStep <= 12)
                    <button type="button" class="btn btm-md btn-success" wire:click="incrementarStep()">Siguiente</button>
                @endif
                @if($actualStep == 13)
