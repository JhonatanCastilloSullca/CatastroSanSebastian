  ...
  <html lang="en">
    ...
    <div style="width: 716px;height:16px;margin: auto;border:none; margin-bottom:5px;background-color:#fff;">
      ...
      <div style="width: 473px;height:16px;margin: auto;" class="bn">              
          <div class="texto fz18 lh14">
              <b style="color:#4646A3"> {{$logos?->desc_institucion}}</b>
          </div>
      </div>
      <div style="width: 473px;height:16px;margin: auto;" class="bn">              
      ...
      <div style="width: 473px;height:16px;margin: auto;" class="bn">              
          ...
          GERENCIA DE DESARROLLO URBANO Y TERRITORIAL<br>
    ...
    <div style="width: 427px;height:16px;margin: auto;">
      ...
      <div style="width: 120px;height: 120px;float:left;border:none;" >
          <img style="padding-top:35px;padding-left:10px;" src="{{$logos?->logo_catastro}}" alt="">
      </div>
    </div>
      ...
      <div style="width: 716px;height:20px; margin-top:5px; float:left;" class="bn ">
        <div class="texto fz8 lh14">
        La gerencia de Desarrollo Urbano; através de la Sub Gerencia de Planeamiento, Fiscalización Urbana y Catastro de la Municipalidad distrital de San Sebastian, en atención al Expediente,.... y al informe n°...., asigna la siguiente numeración de finca:
        </div>
      </div>
