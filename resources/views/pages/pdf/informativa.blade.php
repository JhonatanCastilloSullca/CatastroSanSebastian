  ...
  <html lang="en">
    ...
    <body>
      ...
      <div style="width: 716px;height:20px;  float:left;" class="bn">
        ...
        <div style="width: 135px;height: 16px;float:left;" class="bgfdc">
          <div class="texto fz10 lh14">
            N° DE DOCUMENTO
          </div>
        </div>
      ...
      <div style="width: 716px;height:20px;  float:left;" class="bn">
        <div style="width: 385px;height:455px;float:left;" class="bn">
          <img src="{{asset('storage/img/imageneslotes/'.$ficha?->lote?->manzana?->sectore?->codi_sector.''.$ficha?->lote?->manzana?->codi_mzna.''.$ficha?->lote?->codi_lote.'.jpg')}}" alt="" style="width: 380px;height:455px;  object-fit: contain;image-orientation: from-image;display: flex; flex-direction: row; flex-wrap: wrap; justify-content: center; align-items: center;">  
