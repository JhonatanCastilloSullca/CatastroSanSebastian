    ...
    @foreach($fichas as $ficha)
      ...
      <div style="width: 316px;height:16px;margin: auto;border:none;" class="">
        <div class="texto fz12 lh14" style="font-weight:bold;">
            FICHA CATASTRAL URBANA ACTIVIDAD ECONOMICA
          </div>
      </div>
      ...
      <div style="width: 716px;height:16px;margin: auto;border:none; margin-bottom:5px;background-color:#fff;">
        ...
        <div style="width: 120px;height: 120px;float:left;border:none;" >
          <img style="padding-top:35px;" src="{{$logos?->logo_catastro}}" alt="">
        </div>
      </div>
...
<!--AQUI SE REPETIRA LOS TITULARES CATASTRALES FOREACH-->
      ...
      <div style="width: 716px;height:16px;margin: auto;">
        <div style="width: 98px ;height: 16px;float:left;" class="texto2 fz8 lh14">
          @if($ficha?->conductor!="")
            @if($ficha?->conductor?->persona?->domiciliotitular!="")
              @if($ficha?->conductor?->persona?->domiciliotitular?->departamento!="")
                {{$ficha?->conductor?->persona?->domiciliotitular?->departamento?->descri}}
              @endif
            @endif
          @endif
        </div>
        ...
        <div style="width: 105px;height: 16px;float:left;" class="texto2 fz8 lh14">
          @if($ficha?->conductor!="")
            @if($ficha?->conductor?->persona?->domiciliotitular!="")
              @if($ficha?->conductor?->persona?->domiciliotitular?->provincias!="")
                @foreach($ficha?->conductor?->persona?->domiciliotitular?->provincias as $provincia)
                  @if($provincia?->cod_dep == $ficha?->conductor?->persona?->domiciliotitular?->codi_dep && $provincia?->cod_pro == $ficha?->conductor?->persona?->domiciliotitular?->codi_pro && $provincia?->codi_dis == "00")
                    {{$provincia?->descri}}
                  @endif
                @endforeach
              @endif
        ...
        <div style="width: 123px;height: 16px;float:left;" class="texto2 fz8 lh14">
          @if($ficha?->conductor!="")
            @if($ficha?->conductor?->persona?->domiciliotitular!="")
              @if($ficha?->conductor?->persona?->domiciliotitular?->provincias!="")
                @foreach($ficha?->conductor?->persona?->domiciliotitular?->distritos as $distrito)
                  @if($distrito?->cod_dep == $ficha?->conductor?->persona?->domiciliotitular?->codi_dep && $distrito?->cod_pro == $ficha?->conductor?->persona?->domiciliotitular?->codi_pro && $distrito?->codi_dis == $ficha?->conductor?->persona?->domiciliotitular?->codi_dis)
                    {{$distrito?->descri}}
                  @endif
                @endforeach
              @endif
      ...
      <div style="width: 716px;height:16px;margin: auto;">
        <div style="width: 122px ;height: 16px;float:left;" class="texto2 fz8 lh14" >
          @if($ficha?->conductor!="")
            @if($ficha?->conductor?->persona?->domiciliotitular!="")
              {{$ficha?->conductor?->persona?->domiciliotitular?->codi_via}}
            @endif
          @endif
        </div>
        ...
        <div style="width: 60px;height: 16px;float:left;" class="texto2 fz8 lh14">
          @if($ficha?->conductor!="")
            @if($ficha?->conductor?->persona?->domiciliotitular!="")
              {{$ficha?->conductor?->persona?->domiciliotitular?->tipo_via}}
            @endif
          @endif
        </div>
        ...
        <div style="width: 266px;height: 16px;float:left;"class="texto2 fz8 lh14" >
          @if($ficha?->conductor!="")
            @if($ficha?->conductor?->persona?->domiciliotitular!="")
              {{$ficha?->conductor?->persona?->domiciliotitular?->nomb_via}}
            @endif
          @endif
        </div>
        ...
        <div style="width: 74px;height: 16px;float:left;" class="texto2 fz8 lh14">
          @if($ficha?->conductor!="")
            @if($ficha?->conductor?->persona?->domiciliotitular!="")
              {{$ficha?->conductor?->persona?->domiciliotitular?->nume_muni}}
            @endif
          @endif
        </div>
        ...
        <div style="width: 123px;height: 16px;float:left;" class="texto2 fz8 lh14">
          @if($ficha?->conductor!="")
            @if($ficha?->conductor?->persona?->domiciliotitular!="")
              {{$ficha?->conductor?->persona?->domiciliotitular?->nomb_edificacion}}
            @endif
          @endif
        </div>
        ...
        <div style="width: 65px;height: 16px;float:left;" class="texto2 fz8 lh14" >
          @if($ficha?->conductor!="")
            @if($ficha?->conductor?->persona?->domiciliotitular!="")
              {{$ficha?->conductor?->persona?->domiciliotitular?->nume_interior}}
            @endif
          @endif
        </div>
      </div>
