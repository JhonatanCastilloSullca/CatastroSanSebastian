      ...
      <div class="card-body">
        ...
        <div class="form-group row">
            <div class="col-md-12 mb-2">
                <span style="font-size: 20px"><strong style="color:  #6c6c6c;">Actual: </strong>{{$contadorfichas}}</span>&nbsp;&nbsp;&nbsp;&nbsp;
                <span style="font-size: 20px"><strong style="color:  #6c6c6c;">Total: </strong>{{$contadorsector}}</span>&nbsp;&nbsp;&nbsp;&nbsp;                    
            </div>
        </div>
