      ...
      <div class="card">
        <div class="row">
          <div class="col-md-5 pe-md-0">
            <div class="auth-side-wrapper imagen_principal" style="background-image: url({{asset('storage/img/muni.jpg')}} );">
          ...
          <div class="col-md-7 ps-md-0">
            ...
            <div class="auth-form-wrapper px-4 py-5">
              <a href="#" class="noble-ui-logo d-block mb-2">MUNICIPALIDAD DISTRITAL DE SAN SEBASTIAN</a>
