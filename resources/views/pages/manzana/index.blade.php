              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    @endcan
                    @can('manzana.destroy')
                    <button type="button" class="btn btn-danger btn-icon" data-bs-toggle="modal" data-bs-target="#Eliminar" data-id="{{$manzana->codi_mzna}}">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('manzana.update','test')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
          ...
          <input type="hidden" name="id_sector_ant" class="id_sector_ant">
          @include('pages.manzana.form')
        </form>
      </div>
    </div>
      ...
      <div class="modal-body">
        <form action="{{route('manzana.destroy','test')}}" method="POST" autocomplete="off">
          ...
          <div class="modal-footer">
            <input type="hidden" name="id_manzana_2" class="id_manzana_2">
...
<script>
  ...
  editar.addEventListener('show.bs.modal', function(event) {
    ...
    var id_sector_antModal = editar.querySelector('.id_sector_ant')
    ...
    id_sector_antModal.value = id_sector;
