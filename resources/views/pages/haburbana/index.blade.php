            ...
            <table id="especialidad" class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @can('haburbana.edit')
                    <button type="button" class="btn btn-primary btn-icon edit" data-bs-toggle="modal" data-bs-target="#Editar" data-id="{{$haburbana->codi_hab_urba}}" data-grup_urba="{{$haburbana->grup_urba}}" data-tipo_hab_urba="{{$haburbana->tipo_hab_urba}}" data-nomb_hab_urba="{{$haburbana->nomb_hab_urba}}" data-codi_hab_urba="{{$haburbana->codi_hab_urba}}">
                      <i data-feather="edit"></i>
                    </button>
                    @endcan
                    @can('haburbana.destroy')
                    <button type="button" class="btn btn-danger btn-icon" data-bs-toggle="modal" data-bs-target="#Eliminar" data-id="{{$haburbana->codi_hab_urba}}">
