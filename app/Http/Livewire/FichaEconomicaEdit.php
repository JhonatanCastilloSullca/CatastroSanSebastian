...
class FichaEconomicaEdit extends Component
{
    ...
    public function mount(Ficha $fichaanterior)
    {
        ...
        foreach($fichaanterior->autorizacion_anuncios as $i => $autorizaciones){
            ...
            if($autorizaciones->fecha_vencimiento1!="1969-12-31"){
                $this->fecha_vencimiento1[$i]=$autorizaciones->fecha_vencimiento1;
            }
        }
        ...
        $this->actividades=Actividades::orderBy('codi_actividad','asc')->get();
        ...
        try
        {
            ...
            if($autorizaciones!=""){
                while($contcon < $this->cont2){
                    $anuncio22=AutorizacionAnuncio::count()+1;
