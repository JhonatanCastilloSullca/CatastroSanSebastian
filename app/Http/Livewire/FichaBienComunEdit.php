...
class FichaBienComunEdit extends Component
{
    ...
    public function reducirRecap()
    {


        if($this->cont5 > 0){
            $this->cont5--;
            array_splice($this->rbcedifica, $this->cont5,1);
            array_splice($this->rbcentrada, $this->cont5, 1);
            array_splice($this->rbcnume_piso, $this->cont5, 1);
            array_splice($this->rbcunidad, $this->cont5, 1);
            array_splice($this->rbctotalporcentaje, $this->cont5, 1);
            array_splice($this->rbctotalatc, $this->cont5, 1);
            array_splice($this->rbctotalacc, $this->cont5,1);
            array_splice($this->rbctotalaoic, $this->cont5, 1);
        }
    }
