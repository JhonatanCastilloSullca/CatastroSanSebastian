...
class FichaIndividualEdit extends Component
{
    ...
    public function mount(Ficha $fichaanterior)
    {
        ...
        if($fichaanterior->domiciliotitular!="")
        {
            ...
            $this->telefonodomicilio=$fichaanterior->domiciliotitular->telf;
            $this->anexodomicilio=$fichaanterior->domiciliotitular->anexo;
            $this->emaildomicilio=$fichaanterior->domiciliotitular->email;
        ...
        try
        {
            ...
            for($i=0;$i<$this->cont3;$i++){
                $this->validate([
                    ...
                    'inst_uni_med.'.$i                => 'nullable|max:10',
                    'inst_uca.'.$i                    => 'nullable',
                ]);
            }
