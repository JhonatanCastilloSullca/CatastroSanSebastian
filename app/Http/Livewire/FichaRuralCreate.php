    ...
    public function register()
    {
        try
        {
            ...
            $this->validate([
                ...
                'unidad_organica'       =>'nullable|max:15',
                'unidad_catastral'      =>'nullable|max:15',
            ...
            $ficha->id_uni_cat="08070104001001010101001";
            ...
            if($this->tipoTitular==1)
            {
                ...
                if($buscarpersona2!=""){
                    ...
                    $titular->fax=$this->anexodomicilio;
            ...
            if($this->vivienda=="on"){
                $documento_posesions->vivienda=1;
            }else{
                $documento_posesions->vivienda=2;
            }

            if($this->establo=="on"){
                $documento_posesions->establo=1;
            }else{
                $documento_posesions->establo=2;
            }

            if($this->corral=="on"){
                $documento_posesions->corral=1;
            }else{
                $documento_posesions->corral=2;
            }

            if($this->galpon=="on"){
                $documento_posesions->galpon=1;
            }else{
                $documento_posesions->galpon=2;
            }

            if($this->invernadero=="on"){
                $documento_posesions->invernadero=1;
            }else{
                $documento_posesions->invernadero=2;
            }

            if($this->reservorio=="on"){
                $documento_posesions->reservorio=1;
            }else{
                $documento_posesions->reservorio=2;
            }

            if($this->deposito=="on"){
                $documento_posesions->deposito=1;
            }else{
                $documento_posesions->deposito=2;
            }

            if($this->zona_arque=="on"){
                $documento_posesions->zona_arque=1;
            }else{
                $documento_posesions->zona_arque=2;
            }

            if($this->otros=="on"){
                $documento_posesions->otros=1;
            }else{
                $documento_posesions->otros=2;
            }
            ...
            if($litigantes!=""){
                ...
                if($this->tipo_usoactual!=""){
                    while(count($this->tipo_usoactual)>$contagri){
                        ...
                        if(isset($this->tipo_agritipo_usoactualcola[$contagri])){
                ...
                if($this->tipo_ganaderia!=""){
                    while(count($this->tipo_ganaderia)>$contganad){
                        ...
                        if(isset($this->tipo_ganaderia[$contganad])){
                            $ganaderia->tipo_ganaderia=$this->raza_especie[$contganad];
                        }else{
